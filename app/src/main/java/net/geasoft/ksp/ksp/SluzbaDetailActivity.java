...
public class SluzbaDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(SluzbaDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(SluzbaDetailFragment.ARG_ITEM_ID));
            final SluzbaDetailFragment fragment = new SluzbaDetailFragment();
            fragment.setArguments(arguments);

            actionBar.setTitle(getIntent().getStringExtra("naslov"));
            
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.sluzba_detail_container, fragment)
                    .commit();
        }
    }
